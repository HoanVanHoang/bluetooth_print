...
class FormInputScreen extends StatefulWidget {
  FormInputScreen({Key key, this.number}) : super(key: key);
  final String number;

  @override
  State<StatefulWidget> createState() {
    return FormInputScreenState();
  }
}

class FormInputScreenState extends State<FormInputScreen> {
  String dateString = "";
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () async{
                  ...
                  if(singletonData.deviceSelected==null){
                    UtilsDialog.showAlertDialogOk(context,Strings.device_dont_selected, Strings.notify);
                  }else{
                    _startPrint(singletonData.deviceSelected);
                  }
                },
                child: Container(
                  width: 200,
  ...
  Future<void> _startPrint(PrinterBluetooth printer) async {
    ...
    if(result.value == PosPrintResult.printerNotSelected){
      ...
      UtilsDialog.showAlertDialogPrintSuccess(context, result.value.toString(), Strings.notify);
    }
  }
